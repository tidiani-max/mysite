...
const Contact = () =>{
    ...
    emailjs.sendForm('service_cmlatp7', 'template_axo1cri', form.current, '7LyF7P8vPFoZBGEnd')
        .then((result) => {
        ...
        <section id="contactPage">
            <div id="clients">
                ...
                <p className="clientDesc">
                    i didn't work for any company yet i'm still student i ll like to work for theses company in the future
                </p>
